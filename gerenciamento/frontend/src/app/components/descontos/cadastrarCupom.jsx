      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className={styles.formGroup}>
          <label className={styles.label}>
            <input type="checkbox" name="estado" checked={form.estado} onChange={handleChange} /> Ativo
          </label>
        </div>
        ...
        <div className={styles.formGroup}>
          ...
          <select className={styles.select} name="aplicacao" value={form.aplicacao} onChange={handleChange}>
        ...
        {form.aplicacao === "produto" && (
          <div className={styles.formGroup}>
            ...
            <select className={styles.select} name="produto" value={form.produto} onChange={handleChange}>
